// DO NOT EDIT. This is code generated via package:flutter_multitenancy/flutter_multitenancy.dart
...
class LocaleKeys {
  ...
  static const error_tenant_not_found = 'error_tenant_not_found';
...
class Locales {
  static const en = {
    ...
    'error_update_cli': 'There was an error upgrading flutter_multitenancy',
    'error_folder_not_found': 'Folder %s not found',
    'error_tenant_not_found': 'Tenant %s not found',
    ...
    'hint_update': 'To update flutter_multitenancy',
    ...
    'info_cli_last_version_already_installed':
        'Latest version of flutter_multitenancy already installed',
  ...
  static const pt_BR = {
    ...
    'error_update_cli': 'Ocorreu um erro ao atualizar flutter_multitenancy',
    'error_folder_not_found': 'Pasta %s não encontrada',
    'error_tenant_not_found': 'Tenant %s não encontrado',
    ...
    'hint_update': 'Para atualizar flutter_multitenancy',
    'hint_version': 'Mostra a versão atual do flutter_multitenancy',
    ...
    'info_cli_last_version_already_installed':
        'Versão mais recente de flutter_multitenancy já instalada',

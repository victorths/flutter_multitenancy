...
class FlutterMultitenancy {
  final List<String> _arguments;

  FlutterMultitenancy(this._arguments) {
    _instance = this;
  }

  static FlutterMultitenancy _instance;
  static FlutterMultitenancy get to => _instance;
...
class ErrorCommand extends Command {
  ...
  Future<void> execute() async {
    ...
    LogService.info('run `multitenancy help` to help', false, false);
  }
